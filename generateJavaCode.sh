...
OAS_FILE=cirqitOpenApi_v1.0.3.yml
...
# remove unused OffsetDateTime import — with dateLibrary=java8-localdatetime we always use LocalDateTime
find . -name "*.java" -exec sed -i '/^import java\.time\.OffsetDateTime;$/d' {} +
